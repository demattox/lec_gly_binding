...
os.chdir('/Users/dmattox/cbk/glycan_binding/analysis/prelim/prelim3/')


datIn = './allFeats_pc50.csv'
labsIn = './allFeats_pc50_labels.tsv'
...
#save out tSNE
outFile = 'allFeats_tSNE_prelim_p30.csv'
...
plt.scatter(tsne_default[:,0], tsne_default[:,1], s=1,
            color = foldCols)
plt.title('t-SNE from all features, colored by lectin fold')
plt.tight_layout()
...
plt.scatter(tsne_default[:,0], tsne_default[:,1], s=1,
            color = origCols)
plt.title('t-SNE from all features, colored by lectin origin')
plt.tight_layout()
...
plt.scatter(tsne_default[:,0], tsne_default[:,1], s=1,
           color = uniCols)
plt.title('t-SNE from all features, colored by uniprotIDs')
plt.tight_layout()
...
datIn = './distFeats_pc50.csv'
        
dist_X = np.genfromtxt(datIn, delimiter = ',',  skip_header = 1)

%time distFeats_tsne_default = fast_tsne(dist_X, seed=42)

plt.figure(figsize=(5,5))
plt.gca().set_aspect('equal', adjustable='datalim')
plt.scatter(distFeats_tsne_default[:,0], distFeats_tsne_default[:,1], s=1,
            color = origCols)
plt.title('t-SNE from geometery only, colored by lectin origin')
plt.tight_layout()
...
plt.scatter(distFeats_tsne_default[:,0], distFeats_tsne_default[:,1], s=1,
            color = uniCols)
plt.title('t-SNE from geometery only, colored by uniprotIDs')
plt.tight_layout()
...
plt.scatter(distFeats_tsne_default[:,0], distFeats_tsne_default[:,1], s=1,
            color = foldCols)
plt.title('t-SNE from geometery only, colored by lectin fold')
plt.tight_layout()

###########################################
# Original feats

datIn = './resiFeats_pc50.csv'
        
resi_X = np.genfromtxt(datIn, delimiter = ',',  skip_header = 1)

%time resiFeats_tsne_default = fast_tsne(resi_X, seed=42)

plt.figure(figsize=(5,5))
plt.gca().set_aspect('equal', adjustable='datalim')
plt.scatter(resiFeats_tsne_default[:,0], resiFeats_tsne_default[:,1], s=1,
            color = origCols)
plt.title('t-SNE from resi bins only, colored by lectin origin')
plt.tight_layout()
...
plt.scatter(resiFeats_tsne_default[:,0], resiFeats_tsne_default[:,1], s=1,
            color = uniCols)
plt.title('t-SNE from resi bins only, colored by uniprotIDs')
plt.tight_layout()
...
plt.scatter(resiFeats_tsne_default[:,0], resiFeats_tsne_default[:,1], s=1,
            color = foldCols)
plt.title('t-SNE from resi bins only, colored by lectin fold')
plt.tight_layout()
