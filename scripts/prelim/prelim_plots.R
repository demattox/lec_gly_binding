...
dat = read.delim(file = '/Users/dmattox/cbk/glycan_binding/analysis/prelim/prelimData.tsv', sep = '\t', header = T, stringsAsFactors = F)
...
bsDat = dat[,c(11, 13:31, 33:44, 46:57, 59:79)] # filter out non-binding site columns and columns 32, 45, & 58 for having 0 record pi helices
...
monoBSDat = monoDat[,c(11, 13:31, 33:44, 46:57, 59:79)]
...
legend(x = xLim[2]-2.3, y=yLim[2]+0.8, col = c('forestgreen', 'dodgerblue', 'dodgerblue', 'gold', 'gold','red', 'darkorchid'), pt.bg	 = c(NA, NA, NA, NA, NA, NA, 'darkorchid'), legend = c('Man','Glc','GlcNAc','Gal','GalNAc', 'Fuc', 'NeuAc'), pch=c(19,19,15,19,15,17,23), bty = 'n', cex = 1.4)
...
out = pca$x[,1:50]
labs = dat[,1:12]
write.csv(file = '/Users/dmattox/cbk/glycan_binding/analysis/prelim_pc50.csv', out, quote = F, row.names = F, col.names = F)
write.table(file = '/Users/dmattox/cbk/glycan_binding/analysis/prelim_pc50_labels.tsv', labs, sep = '\t', quote = F, row.names = F)
...
seqs = readFASTA('/Users/dmattox/cbk/glycan_binding/analysis/uniprot-uniDat_seqs.fasta')
...
pdf(file = '/Users/dmattox/Documents/qbs/cbk/glycan_binding/analysis/plots/prelim_heatmap.pdf')
...
pdf(file = '/Users/dmattox/Documents/qbs/cbk/glycan_binding/analysis/plots/prelim_heatmap_zscores.pdf')
...
cdhit = read.csv("/Users/dmattox/cbk/glycan_binding/analysis/1592235610.result/1592235610.fas.1.clstr.sorted", sep = "\t", row.names = NULL, header = FALSE, stringsAsFactors = FALSE)
prev =""
